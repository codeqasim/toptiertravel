        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-box payment-received-wrap mb-2">
                 ...
                 <?php if($booking_data->supplier!="cartrawler"){include "App/Views/Payment_methods.php";}?>
                    ...
                    <div class="form-content">
                        <div class="card-item shadow-none radius-none mb-0">
                            <div class="card-img pb-2">
                             <img class="lazyload" src="<?php if (isset($booking_data->car_img)){ echo $booking_data->car_img; } else { echo root."assets/img/hotel.jpg";} ?>" alt="img">
                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <ul class="list-items list-items-2 pt-3">
                                    <li><span><?=T::sub_total?>:</span><?=currency?>  </li>
                                ...
                                <!-- <li class="lh-1 mt-0"><span><?=T::price?></span><?=currency?> <?= number_format( $booking_data->price,2) ?></li>
                                ...
                                <strong class="col-6 d-flex align-items-center h4 m-0"><strong><small class="mx-2"><?=currency?></small></strong>
                                    <input name="total_price" class="total" readonly type="text" value="<?= number_format( $booking_data->price,2) ?>" style="background: transparent; border: 0; color: #fff;">
                                </strong>
                                ...
                                $("#agent_fee").on('keyup', function(event) {
                                    ...
                                    var total_val = parseFloat("<?= number_format( $booking_data->price,2) ?>") || 0; // Default to 0 if not a valid number
