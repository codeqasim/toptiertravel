<section data-anim-wrap class="masthead -type-7 pt-0">
   ...
   <ul class="nav nav-tabs p-0 d-none" id="tab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
         <button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#tab-flights" type="button" role="tab"
            aria-controls="profile-tab-pane" aria-selected="false">
            <svg style="transform: rotate(90deg);" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"
               class="block" data-v-ee08ca94="">
               <path
      ...
      <li class="nav-item" role="presentation">
         <button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#tab-visa" type="button" role="tab"
            aria-controls="profile-tab-pane" aria-selected="false">
            <svg style="fill:#fff!important;stroke:var(--theme-bg)!important" width="22" height="22" viewBox="0 0 24 24"
   ...
   <div data-anim-child="fade delay-3" class="mainSearch  -w-900  tabs -underline mt-60 js-tabs">
      <div class="tabs__controls d-flex x-gap-30 y-gap-20 justify-center sm:justify-start js-tabs-controls">
         ...
         <?php
            ...
            // Counter to track the first button
            $first = true;
         ...
         <div class="">
            <button
               class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button <?= $first ? 'is-tab-el-active' : '' ?>"
               data-tab-target=".-tab-item-hotels" data-bs-toggle="tab" data-bs-target="#tab-hotels" type="button"
         ...
         <div class="">
            <button
               class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button <?= $first ? 'is-tab-el-active' : '' ?>"
               data-tab-target=".-tab-item-flights" data-bs-toggle="tab" data-bs-target="#tab-flights" type="button"
               role="tab" aria-controls="home-tab-pane" aria-selected="true">
               <span>
                  <?=T::flights?>
               </span>
         ...
         <div class="">
            <button
               class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button <?= $first ? 'is-tab-el-active' : '' ?>"
               data-tab-target=".-tab-item-tours" data-bs-toggle="tab" data-bs-target="#tab-tours" type="button"
               role="tab" aria-controls="home-tab-pane" aria-selected="true">
               <span>
                  <?=T::tours?>
               </span>
         ...
         <div class="">
            <button
               class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button <?= $first ? 'is-tab-el-active' : '' ?>"
               data-tab-target=".-tab-item-cars" data-bs-toggle="tab" data-bs-target="#tab-cars" type="button"
               role="tab" aria-controls="home-tab-pane" aria-selected="true">
               <span>
                  <?=T::cars?>
               </span>
         ...
         <div class="">
            <button
               class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button <?= $first ? 'is-tab-el-active' : '' ?>"
               data-tab-target=".-tab-item-visa" data-bs-toggle="tab" data-bs-target="#tab-visa" type="button"
               role="tab" aria-controls="home-tab-pane" aria-selected="true">
               <span>
                  <?=T::visa?>
               </span>
      ...
      <div class="--button-grid items-center mt-2 -w-900">
         <div class="main_search">
            <div
               class="tabs__content mt-30 md:mt-20 js-tabs-content bg-white rounded-100 -w-900 bg-white px-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 shadow-2 mt-40">
               <?php
                  $modules = [
               ...
               ?>
               <div class="tabs__pane -tab-item-<?php echo $m->type; ?> <?= $first ? 'is-tab-el-active' : '' ?>"
                  tabindex="0">
                  ...
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="testimonials -type-2">
                           ...
                           <div class="text-22 md:text-18 fw-600 text-dark-1">"Trust in our expertise to turn your
                              travel dreams into a seamless reality. With meticulous planning & attention to detail, we
                              ensure that every aspect of your journey exceeds your wildest expectations.
                              "
                           </div>
                     ...
                     <div class="swiper-slide">
                        <div class="testimonials -type-2">
                           ...
                           <div class="text-22 md:text-18 fw-600 text-dark-1">"Our family was traveling via bullet train
                              between cities in Japan with our luggage - the location for this hotel made that so easy.
                              Agoda price was fantastic."</div>
                           <div class="d-flex items-center mt-35">
         ...
         <div class="col px-0">
            <div class="d-flex justify-center flex-column h-400 px-80 py-40 md:px-30 bg-green-1">
               ...
               <div class="row my-3">
                  <div class="col-6">
                     <div class="form-floating">
                        <input type="text" placeholder=" " name="name" value=""
                           class=" bg-white h-60 newsletter_name form-control">
                        <label for="">
                           <?=T::name?>
                        </label>
                     </div>
                  ...
                  <div class="col-6">
                     <div class="form-floating">
                        <input type="bg-white h-60 text" placeholder=" " name="email" value=""
                           class=" bg-white h-60 newsletter_email form-control">
                        <label for="">
                           <?=T::email?>
                        </label>
                     </div>
                  ...
                  <div class="col-12 col-md-6">
                     <button class="mt-3 subscribe button -md h-60 -blue-1 bg-yellow-1 text-dark-1">
                        <?=T::signup?>
                        <?=T::newsletter?>
                     </button>
                     <div class="loading_button" style="display:none">
                        <button style="height:58px !important"
                           class="loading_button btn btn-outline-primary w-100 h-100" type="button" disabled>
