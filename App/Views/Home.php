      ...
      <div class="container">
        ...
        <div class="row y-gap-30 pt-40">
          ...
          <div class="w-1/5 lg:w-1/3 sm:w-1/2">
            ...
            <a href="#" class="citiesCard -type-2 ">
              <div class="citiesCard__image rounded-4 ratio ratio-23:18">
                <img class="img-ratio rounded-4 js-lazy" data-src="img/stays/1/1.png" src="#" alt="image">
              </div>
          ...
          <div class="w-1/5 lg:w-1/3 sm:w-1/2">
            ...
            <a href="#" class="citiesCard -type-2 ">
              <div class="citiesCard__image rounded-4 ratio ratio-23:18">
                <img class="img-ratio rounded-4 js-lazy" data-src="img/stays/1/2.png" src="#" alt="image">
              </div>
          ...
          <div class="w-1/5 lg:w-1/3 sm:w-1/2">
            ...
            <a href="#" class="citiesCard -type-2 ">
              <div class="citiesCard__image rounded-4 ratio ratio-23:18">
                <img class="img-ratio rounded-4 js-lazy" data-src="img/stays/1/3.png" src="#" alt="image">
              </div>
          ...
          <div class="w-1/5 lg:w-1/3 sm:w-1/2">
            ...
            <a href="#" class="citiesCard -type-2 ">
              <div class="citiesCard__image rounded-4 ratio ratio-23:18">
                <img class="img-ratio rounded-4 js-lazy" data-src="img/stays/1/4.png" src="#" alt="image">
              </div>
          ...
          <div class="w-1/5 lg:w-1/3 sm:w-1/2">
            ...
            <a href="#" class="citiesCard -type-2 ">
              <div class="citiesCard__image rounded-4 ratio ratio-23:18">
                <img class="img-ratio rounded-4 js-lazy" data-src="img/stays/1/5.png" src="#" alt="image">
              </div>
