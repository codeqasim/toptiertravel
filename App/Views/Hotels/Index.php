...
<section class="mb-4 feature hotels">
<section class="container" style="border-radius:10px;padding:50px 0px">
<div class="container">
<h2 class="text-center text-white mt-5 text-capitalize">

<!-- <svg class="d-block text-center mx-auto mb-2" fill="" width="50" height="50" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
<path
...
<strong><?=T::hotels_searchforbesthotels?></strong></h2>
