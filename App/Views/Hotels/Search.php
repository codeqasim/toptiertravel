<form id="hotels-search" class="content m-0 search_box">
   <div class="row mb-0 g-2">
      ...
      <div class="col-lg-1">
         <button style="height: 64px; border-radius:50px" type="submit" class="searchBtn search_button w-100 btn btn-primary btn-m rounded-sm font-700 text-uppercase btn-full">
