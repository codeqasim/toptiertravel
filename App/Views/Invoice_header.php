...
<div class="bg-light">
    ...
    <div class="card p-3 mx-auto" id="invoice" >
            ...
            <div class="row">
                <a href="<?=root?>" class="col-sm-4 d-flex align-items-center justify-content-center ">
            ...
            if($data->payment_status=="unpaid"){
                if($data->supplier == "cartrawler"){
                    include "App/Views/Cars/cartrawler_paymentgateway.php";
                }else{
                ?>
