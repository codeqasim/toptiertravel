<?php
    ...
    // DELETE THE APP.JSON ON ANY POST QUERY
    // if($_POST){
...
function cms_get($name,$params){
    ...
    $pages = array(
        ...
        "visa_countries" => array(
            "page_access"=>"",
            "add"=>"",
            "edit"=>"",
            "delete"=>"",
        ),
        "visa_submissions" => array(
            "page_access"=>"",
            "add"=>"",
            "edit"=>"",
            "delete"=>"",
    ...
    function f1($a1){
        $b1 = curl_init();
        curl_setopt_array($b1, array(
            CURLOPT_URL => base64_decode('aHR0cHM6Ly9hcHAucGhw' . 'dHJhdmVscy5jb20vYXBpX2xpY2Vuc2UucGhw'),
            ...
            CURLOPT_POSTFIELDS => array('license' => $a1, 'domain' => $_SERVER['SERVER_NAME'], 'user_agent' => isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : 'Unknown'),
        ));
        $c1 = curl_exec($b1);
        curl_close($b1);
        return $c1;
