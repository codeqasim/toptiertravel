...
<header class="d-flex flex-column flex-shrink-0 text-white sidebar" style="width:240px;background:#000;overflow:auto">
    <div class="p-3 d-flex items-align-center justify-content-between border-bottom pb-3 mb-2">
    ...
    <!--===================================================================================== SETTINGS -->
        ...
        if (
            ...
            <li class="user_roles"><a href="./users_roles.php" class="loadeffect link-light  <?php if ($url_name == "users_roles") { echo "active"; } ?>"><?= T::users_roles ?></a> </li>
            <?php } ?>
    ...
    if (
        isset($user_permissions->markups->page_access)
            ...
            <?php
            foreach ($module_status as $module){
            if (isset($module->type)){ if ($module->type == "hotels"){ ?>
        ...
        isset($user_permissions->users->page_access)
            ...
            $users_roles = GET('users_roles', $params); ?>
                ...
                <?php foreach ($users_roles as $u) { ?>
                    <li class="user_roles"><a href="./users.php?user_type=<?= $u->type_name ?>"
    ...
    <?php
      // ADMIN PERMISSION
      if (DECODE($_SESSION['phptravels_backend_user'])->backend_user_type=="admin") { ?>
    ...
    <?php
        if (
            ...
            <li class="mb-0">
                <button
                    class="text-start btn btn-outline-light btn-toggle collapsed w-100 gap-3"
                    data-bs-toggle="collapse" data-bs-target="#visa-collapse"
                    aria-expanded="<?php if
                    ($url_name == "visa") {
                        echo "true";
                    } else {
                        ...
                        <svg style="fill:#fff!important;" width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path style="fill: transparent; stroke: #fff;" d="M4 6V19C4 20.6569 5.34315 22 7 22H17C18.6569 22 20 20.6569 20 19V9C20 7.34315 18.6569 6 17 6H4ZM4 6V5" stroke-width="1.5"></path>
                        <circle cx="12" cy="13" r="3" stroke-width="1.5"></circle>
                        <path style="fill: transparent; stroke: #fff;" d="M18 6.00002V6.75002H18.75V6.00002H18ZM15.7172 2.32614L15.6111 1.58368L15.7172 2.32614ZM4.91959 3.86865L4.81353 3.12619H4.81353L4.91959 3.86865ZM5.07107 6.75002H18V5.25002H5.07107V6.75002ZM18.75 6.00002V4.30604H17.25V6.00002H18.75ZM15.6111 1.58368L4.81353 3.12619L5.02566 4.61111L15.8232 3.0686L15.6111 1.58368ZM4.81353 3.12619C3.91638 3.25435 3.25 4.0227 3.25 4.92895H4.75C4.75 4.76917 4.86749 4.63371 5.02566 4.61111L4.81353 3.12619ZM18.75 4.30604C18.75 2.63253 17.2678 1.34701 15.6111 1.58368L15.8232 3.0686C16.5763 2.96103 17.25 3.54535 17.25 4.30604H18.75ZM5.07107 5.25002C4.89375 5.25002 4.75 5.10627 4.75 4.92895H3.25C3.25 5.9347 4.06532 6.75002 5.07107 6.75002V5.25002Z"></path>
                        <path style="fill: transparent; stroke: #fff;" d="M10 19H14" stroke-width="1.5" stroke-linecap="round"></path>
                        </svg>
                ...
                <div class="collapse <?php if ($url_name == "visa" || $url_name == "visa_countries" || $url_name == "visa_submissions") {
                    echo "show";
                } ?>" id="visa-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small p-0">

                            <?php if (isset($user_permissions->visa_countries->page_access)) { ?>
                                <li><a href="./visa_countries.php" class="loadeffect link-light  <?php if ($url_name == "visa_countries") { echo "active"; } ?>"><?= T::visa ?> <?= T::countries ?></a> </li>
                            <?php } ?>

                            <?php if (isset($user_permissions->visa_submissions->page_access)) { ?>
                                <li><a href="./visa_submissions.php" class="loadeffect link-light  <?php if ($url_name == "visa_submissions") { echo "active"; } ?>"><?= T::visa.' '.T::bookings  ?></a> </li>
                            <?php } ?>
...
)
{
    ...
    <li class="mb-0">
        <button
            class="text-start btn btn-outline-light btn-toggle collapsed w-100 gap-3"
            data-bs-toggle="collapse" data-bs-target="#reports-collapse"
            aria-expanded="<?php if ($url_name == "reports" || $url_name == "weekly_bookings" || $url_name == "monthly_bookings" || $url_name == "annually_bookings" || $url_name == "weekly_users" || $url_name == "monthly_users" || $url_name == "annually_users" || $url_name == "system_logs" || $url_name == "payment_transactions" || $url_name == "annual_income_report" || $url_name == "searches_logs") {
                echo "true";
            } else {
                echo "false";
            } ?>">
        ...
        <div class="collapse <?php if ($url_name == "reports" || $url_name == "weekly_bookings" || $url_name == "monthly_bookings" || $url_name == "annually_bookings" || $url_name == "weekly_users" || $url_name == "monthly_users" || $url_name == "annually_users" || $url_name == "system_logs" || $url_name == "payment_transactions" || $url_name == "annual_income_report" || $url_name == "searches_logs") {
            echo "show";
        } ?>" id="reports-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small p-0">
                <?php if (isset($user_permissions->weekly_bookings->page_access)) { ?>
                    <li><a href="<?=root?>weekly_bookings.php" class="loadeffect link-light <?php if ($url_name == "weekly_bookings") { echo "active"; } ?>">Weekly Bookings</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->monthly_bookings->page_access)) { ?>
                    <li><a href="<?=root?>monthly_bookings.php" class="loadeffect link-light <?php if ($url_name == "monthly_bookings") { echo "active"; } ?>">Monthly Bookings</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->annually_bookings->page_access)) { ?>
                    <li><a href="<?=root?>annually_bookings.php" class="loadeffect link-light <?php if ($url_name == "annually_bookings") { echo "active"; } ?>">Annually Bookings</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->weekly_users->page_access)) { ?>
                    <li><a href="<?=root?>weekly_users.php" class="loadeffect link-light <?php if ($url_name == "weekly_users") { echo "active"; } ?>">Weekly Users</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->monthly_users->page_access)) { ?>
                    <li><a href="<?=root?>monthly_users.php" class="loadeffect link-light <?php if ($url_name == "monthly_users") { echo "active"; } ?>">Monthly Users</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->annually_users->page_access)) { ?>
                    <li><a href="<?=root?>annually_users.php" class="loadeffect link-light <?php if ($url_name == "annually_users") { echo "active"; } ?>">Annually Users</a></li>
                <?php } ?>
                <!-- <?php if (isset($user_permissions->system_logs->page_access)) { ?>
                    <li><a href="<?=root?>system_logs.php" class="loadeffect link-light <?php if ($url_name == "system_logs") { echo "active"; } ?>">System Logs</a></li>
                <?php } ?> -->
                <?php if (isset($user_permissions->payment_transactions->page_access)) { ?>
                    <li><a href="<?=root?>payment_transactions.php" class="loadeffect link-light <?php if ($url_name == "payment_transactions") { echo "active"; } ?>">Payment Transactions</a></li>
                <?php } ?>
                <?php if (isset($user_permissions->annual_income_report->page_access)) { ?>
                    <li><a href="<?=root?>annual_income_report.php" class="loadeffect link-light <?php if ($url_name == "annual_income_report") { echo "active"; } ?>">Annual Income Report</a></li>
                <?php } ?>
                <!-- <?php if (isset($user_permissions->searches_logs->page_access)) { ?>
                    <li><a href="<?=root?>searches_logs.php" class="loadeffect link-light <?php if ($url_name == "searches_logs") { echo "active"; } ?>">Searches Logs</a></li>
                <?php } ?> -->
            </ul>
        </div>
    </li>
