...
<p class="m-0 page_title"><?=T::flights_suggestions?></p>
</div>
<div class="float-end">
...
$xcrud->table('flights_suggestions');
$xcrud->order_by('id','desc');
$xcrud->relation('city_airport','flights_airports','code','code');
$xcrud->unset_title();
$xcrud->unset_csv();
$xcrud->unset_view();
