...
$xcrud->validation_required('desc');
...
$rooms->fields('status,thumb_img,room_type_id,room_amenities');
...
$rooms->fk_relation('room_amenities', 'id', 'rooms_amenties_fk', 'room_id', 'amenity_id', 'hotels_settings', 'id', array('name'), 'setting_type = "room_amenities"' );
...
$rooms_options->validation_required('price');
...
$xcrud->column_name('desc','Description');
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBvPooGV84U2zlu--JO8IQQvKDakc_VJ6k&libraries=places&callback=initAutocomplete"
async defer></script> -->
