    ...
    <div class="container py-4">
        <form action="module.php" method="POST">
            <div class="card p-5">
                ...
                <img src="assets/img/modules/<?=$module->name?>.png" alt="" class="rounded-3 me-2" style="width:80px;height:80px">

                <div class="px-2">
                <p class="text-capitalize mb-2 fs-4"><strong><?=$module->name?></strong></p>
                ...
                <div class="panel-body">
                    ...
                    <?php if ($module->name == "hotels" || $module->name == "flights" || $module->name == "tours" || $module->name == "cars" || $module->name == "visa" || $module->name == "blog"){?>
