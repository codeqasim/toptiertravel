...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $params = [
         ...
         "agent_commission_status" => $_POST["agentCommissionStatus"],
            ...
            <div class="card mb-2">
               ...
               <div class="card-body p-4">
                  <div class="row g-3">
                     ...
                     <div class="col-md-4">
                        <label for="">
                           <?=T::agent?> <?=T::commission?> <?=T::status?>
                        </label>
                        <div class="form-floating mt-3 rounded-2 h-100">
                           <select class="select2 pt-2" id="agentCommissionSelect" name="agentCommissionStatus" required>
                              <option value="" disabled selected>
                                 <?=T::select?>
                                 <?=T::commission?>
                                 <?=T::status?>
