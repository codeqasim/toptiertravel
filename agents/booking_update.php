    ...
    <div class="p-3">
        ...
        if (!empty($_GET['booking_id']) && !empty($_GET['module']) && !empty($_GET['booking_status']) && !empty($_GET['payment_status']) && !empty($_GET['checkin']) && !empty($_GET['checkout'])) {
            ...
            $db->update(
                ...
                [
                    ...
                    'agent_commission_status' => $_GET['agentCommissionStatus'],
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body p-3">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <select class="form-select" id="agentCommissionStatus" name="agentCommissionStatus">
                                        <option disabled value="">
                                            <?=T::agent?>
                                            <?=T::commission?>
                                            <?=T::status?>
                                        </option>
                                        <option value="pending" <?=($data[0]['agent_commission_status'] ?? '' )==="pending" ? "selected" : "" ;?>>
                                            <?=T::pending?>
                                        </option>
                                        <option value="paid" <?=($data[0]['agent_commission_status'] ?? '' )==="paid" ? "selected" : "" ;?>>
                                            <?=T::paid?>
                                        </option>
                                    </select>
                                    <label for="agentCommission_select">
                                        <?=T::agent?>
                                        <?=T::commission?>
                                        <?=T::status?>
                                    </label>
        ...
        <script>
            $("#search").submit(function (event) {
                ...
                var agentCommissionStatus = $("#agentCommissionStatus").val();
                ...
                window.location.href = "<?=$root?>/agents/booking_update.php?booking_id=" + booking_id + "&module=" + module + "&booking_date=" + booking_date + "&booking_status=" + booking_status + "&payment_status=" + payment_status + "&checkin=" + checkin + "&checkout=" + checkout + "&hotel_id=" + hotel_id + "&first_name=" + first_name + "&last_name=" + last_name + "&email=" + email + "&phone=" + phone + "&room_price=" + room_price + "&platform_comission=" + platform_comission + "&tax=" + tax + "&agent_comission=" + agent_comission + "&bookingPrice=" + bookingPrice + "&bookingnote=" + bookingnote + "&agent_id=" + agent_id + "&room_select=" + room_select + "&supplier_payment_status=" + supplier_payment_status + "&supplier_due_date=" + supplier_due_date + "&agentCommissionStatus=" + agentCommissionStatus + "&cancellation_terms=" + cancellation_terms + "&supplier_cost=" + supplier_cost + "&supplier_id=" + supplier_id + "&supplier_payment_type=" + supplier_payment_type + "&customer_payment_type=" + customer_payment_type + "&customer_payment_type=" + customer_payment_type + "&iata=" + iata;
