      ...
      ?>
        ...
        <script>
            $("#search").submit(function() {
                ...
                window.location.href = "<?=$root?>/agents/bookings.php?booking_id="+booking_id+"&module="+module+"&booking_status="+booking_status+"&payment_status="+payment_status+"&booking_date="+booking_date;
