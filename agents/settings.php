  ...
  <div class="col-lg-8">
     <div class="card card-raised mb-3" style="min-height:760px;">
      <div class="card-body p-4">
        ...
        <div class="row form-group mb-3 multi_theme">
      ...
      <div class="card-body p-4">
        ...
        <div class="row form-group mb-3">
          ...
          <select class="form-select guest_booking" name="guest_booking">
            ...
            <small class="mt-3 d-block">If selected no only registered users will use website</small>
            <hr>
          </div>
        </div>
        <script>
        ...
        <div class="row form-group mb-3 supplier_signup">
        ...
        <div class="row form-group mb-3 agent_signup">
    ...
    <div class="card card-raised mb-3">
      <div class="card-body p-4">
        <div class="card-title"><strong>App Stores Links</strong></div>

        <div class="form-floating mb-3">
        <input type="text" placeholder="" name="android_store" value="<?=$settings->android_store?>" class="form-control">
        <label for="">Android Store Link</label>
        </div>

        <div class="form-floating mb-3">
        <input type="text" placeholder="" name="ios_store" value="<?=$settings->ios_store?>" class="form-control">
        <label for="">iOS Store Link</label>
        </div>

        <div class="form-floating mb-3">
        <select class="form-select" name="show_apps">
        <option value="1">Yes</option>
        <option value="0">No</option>
        </select>
        <label for="">Show Apps</label>
        </div>

        <script>
            $("[name='show_apps']").val(<?=$settings->show_apps?>)
        </script>
  ...
  <div class="col-lg-4">
    ...
    <div class="card card-raised mb-3">
      <div class="card-body p-4">
        ...
        <div class="form-floating mb-3 multi_currency">
